...
The compiler is purpousfully written in a style that is closer to the style associated with Jam. Because of this, there are a couple specific changes from the standard PEP8 compliant python that should be noted:

* Functions use lowerCamelCase
* Documentation is contained in comments, rather than multi-line strings and thereby is written before what it documents
